...
python get_pickle_timit.py --timit_directory=$USER_HOME_DIR/project/wavegan/dataset/timit/TIMIT --output_dir=output/${SLURM_JOB_ID} --time_directory=output --job_id=${SLURM_JOB_ID} #>"output/${SLURM_JOB_ID}/stdout.log"
