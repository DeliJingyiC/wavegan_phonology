...
python get_pickle.py --timit_directory=$USER_HOME_DIR/project/wavegan/dataset/eng_like_sys --output_dir=output/${SLURM_JOB_ID} --time_directory=output --job_id=${SLURM_JOB_ID} #> "output/${SLURM_JOB_ID}/stdout.log"
