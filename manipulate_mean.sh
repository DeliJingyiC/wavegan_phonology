...
# python manipulate.py --model-size 64 --post-proc-filt-len 512 --ngpus 1 --latent-dim 100 --output_dir=$OUTPUT_DIR --num_categ=3 --job_id=$SLURM_JOB_ID --model_path=/users/PAS2062/delijingyic/project/wavegan/nasalDNN/output/890 --random_range=1 --num_epochs=2 --alter_axis=93,82 --alter_range=-5,5,1 --filter_range=0.35,0.65 --control_non_alter_vals=true --fix_laten_vals_accross_alter_vals=true > "${OUTPUT_DIR}/stdout.log"

# 2022-09-28
python manipulate.py --model-size 64 --post-proc-filt-len 512 --ngpus 1 --latent-dim 100 --output_dir=$OUTPUT_DIR --num_categ=3 --job_id=$SLURM_JOB_ID --model_path=/users/PAS2062/delijingyic/project/wavegan/nasalDNN/output/1180 --random_range=1 --num_epochs=2 --alter_axis=60,71 --alter_range=-5,5,1 --filter_range=0.35,0.65 --batch_size=50 --initialize_mode=normal --control_non_alter_vals=false --fix_laten_vals_accross_alter_vals=false > "${OUTPUT_DIR}/stdout.log"

# Manipulate latent variables verses 
